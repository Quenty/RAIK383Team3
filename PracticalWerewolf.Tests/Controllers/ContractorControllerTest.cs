...
namespace PracticalWerewolf.Tests.Controllers
{
    ...
    public class ContractorControllerTest : ControllerTest
    {
        ...
        public void Index_ExistingUser_ViewWithViewModel()
        {
            ...
            var controller = new ContractorController(userManager.Object, orderService.Object, contractorService.Object, unitOfWork.Object, routePlannerService.Object);
        ...
        public void Approve_Guid_Redirect()
        {
            ...
            var routePlannerService = new Mock<IRoutePlannerService>();
            var controller = new ContractorController(mockContext, orderService.Object, contractorService.Object, unitOfWork.Object, routePlannerService.Object);
        ...
        public void Register_UserWithContractorInfo_RedirectToIndex()
        {
            ...
            var unitOfWork = new Mock<IUnitOfWork>();
            var routePlannerService = new Mock<IRoutePlannerService>();
            var controller = new ContractorController(context.Object, orderService.Object, contractorService.Object, unitOfWork.Object, routePlannerService.Object);
