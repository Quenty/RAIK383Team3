namespace PracticalWerewolf.Migrations
{
    ...
    public partial class UpdateTruckCapacityUnitRequirements : DbMigration
    {
        public override void Up()
        {
            ...
            RenameColumn(table: "dbo.Trucks", name: "CurrentCapacity_TruckCapacityUnitGuid", newName: "UsedCapacity_TruckCapacityUnitGuid");
            RenameIndex(table: "dbo.Trucks", name: "IX_CurrentCapacity_TruckCapacityUnitGuid", newName: "IX_UsedCapacity_TruckCapacityUnitGuid");
        ...
        public override void Down()
        {
            ...
            RenameIndex(table: "dbo.Trucks", name: "IX_UsedCapacity_TruckCapacityUnitGuid", newName: "IX_CurrentCapacity_TruckCapacityUnitGuid");
            RenameColumn(table: "dbo.Trucks", name: "UsedCapacity_TruckCapacityUnitGuid", newName: "CurrentCapacity_TruckCapacityUnitGuid");
            CreateIndex("dbo.Trucks", "MaxCapacity_TruckCapacityUnitGuid");
